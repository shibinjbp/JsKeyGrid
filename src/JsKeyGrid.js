     ...
     function grid(options,element,that){
        ...
        //  var curnt_this = that;
         $(options.addButton).on("click", function(){
            ...
            // $('.mydate').datepicker({autoclose: true,todayHighlight: true});
            // $('input[name="mydate'+index+'"]').datepicker();
                ...
                var xxx =0;
                   switch(options.tableType[iCount]){
                     ...
                     case 'dropDown':
                        ...
                        break;
                      case 'dateBox':
                        rowElemnt += '<td class="'+options.tableType[iCount]+[iCount]+' '+options.tableType[iCount]+'" sel_id=""><input type="text" name="mydate'+index+'" bindstat="0" class="mydate xx '+options.tableTdClass[iCount]+' '+options.tableTdClass[iCount]+[iCount]+'" style="border:none;"  /></td>'
                        break;
                      case 'Box':
          ...
          _saveAlldatas: function (element){
              ...
              $that.find("tbody tr").each(function(){
                     ...
                     $(this).find('td input:text,td select').each(function(){
                         tdArray.push({name:thdArray[x],value:this.value});
                        //  tdArray.push({name:thdArray[x],value:this.value});
                        //  tdArray.push(this.value);
                        x++;
                     })
                     tdArray.shift();
